    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="flex justify-between items-center mb-6 bg-white p-6 shadow-xl sm:rounded-lg">
                <h2 class="font-semibold text-xl text-gray-800 leading-tight">Listado de Barberos / Staff</h2>
                <a href="{{ route('staff.create') }}" class="inline-flex items-center px-4 py-2 bg-amber-500 hover:bg-amber-600 border border-transparent rounded-md font-semibold text-xs text-amber-700 uppercase tracking-widest shadow transition ease-in-out duration-150">+ Nuevo Barbero</a>
            </div>
